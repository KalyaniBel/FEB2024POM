...
//**************************************************************	
	...
	public void doSelectByIndex(By locator, int index) {
		Select select_element = new Select(getElement(locator));
		select_element.selectByIndex(index);
	}

	public void doSelectByVisibleText(By locator, String text) {
		Select select_element = new Select(getElement(locator));
		select_element.selectByVisibleText(text);
	}

	public void doSelectByIndex(By locator, String value) {
		Select select_element = new Select(getElement(locator));
		select_element.deselectByValue(value);
	}
	...
	public void selectValueFromDropDownWithoutSelect(By locator1, String optionText1) {
		List<WebElement> optionList = driver.findElements(locator1);
		for (WebElement e : optionList) {
			String text = e.getText();
			if (text.equals(optionText1)) {
				e.click();
				break;
			}
		}
	...
	public void selectMultipleInDropDown(By locator) {
		Select select = new Select(getElement(locator));
		System.out.println("The DropDown Is Multiple Select Type ----" + select.isMultiple());
	...
	public void deSelectSingleOptionInDropDown(By locator, String deselectitem) {
		Select select = new Select(getElement(locator));
		List<WebElement> optionslist = select.getOptions();
		for (WebElement e : optionslist) {
			if (e.getText().equals(deselectitem)) {
				select.deselectByVisibleText(deselectitem);
				break;
			}
		}
	...
	public void deSelectAllSelectedOptionsInDropDown(By locator) {
		Select select = new Select(getElement(locator));
		select.deselectAll();
	}
